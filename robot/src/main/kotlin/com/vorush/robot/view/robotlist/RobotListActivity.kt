...
import com.vorush.robot.domain.Injector
import com.vorush.robot.view.robotdetails.RobotDetailsActivity
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.disposables.Disposables
import io.reactivex.schedulers.Schedulers
import kotlinx.android.synthetic.main.activity_robot_list.progress
import com.vorush.robot.domain.Robot as DomainRobot
import com.vorush.robot.view.Robot as ViewRobot
...
class RobotListActivity :
    ...
    override fun onRobotAdded(name: String) {
        robotUseCaseDisposable = robotUseCase.getRobot(name)
                ...
                .subscribe { robot: com.vorush.robot.view.Robot ->
